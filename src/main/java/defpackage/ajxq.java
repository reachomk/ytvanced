...
/* renamed from: ajxq */
public final class ajxq extends aoca {
    public akab a;
    ...
    public final boolean equals(Object obj) {
        ...
        } else if (!akab.equals(ajxq.a)) {
            return false;
        }
        aocb aocb = this.unknownFieldData;
        if (aocb != null && !aocb.b()) {
            return this.unknownFieldData.equals(ajxq.unknownFieldData);
        }
        aocb aocb2 = ajxq.unknownFieldData;
