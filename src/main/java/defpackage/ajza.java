...
/* renamed from: ajza */
public final class ajza extends ajwo {
    public ajyx a;
    public awqo[] b;
    public ajzw c;
    public aojc d;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof ajza) {
            ...
            } else if (!ajyx.equals(ajza.a)) {
                return false;
            }
            if (aocd.a(this.b, ajza.b)) {
                ajzw ajzw = this.c;
                if (ajzw == null) {
                    if (ajza.c != null) {
                        return false;
                    }
                } else if (!ajzw.equals(ajza.c)) {
                    return false;
                }
                aojc aojc = this.d;
                if (aojc == null) {
                ...
                } else if (!aojc.equals(ajza.d)) {
                    return false;
                }
                if (Arrays.equals(this.e, ajza.e)) {
                    ajzw = this.g;
                    if (ajzw == null) {
                        if (ajza.g != null) {
                            return false;
                        }
                    } else if (!ajzw.equals(ajza.g)) {
                        return false;
                    }
                    String str = this.f;
                    if (str == null) {
                    ...
                    } else if (!str.equals(ajza.f)) {
                        return false;
                    }
                    aocb aocb = this.unknownFieldData;
                    if (aocb != null && !aocb.b()) {
                        return this.unknownFieldData.equals(ajza.unknownFieldData);
                    }
                    aocb aocb2 = ajza.unknownFieldData;
    ...
    public final int hashCode() {
        ...
        int i = 0;
        int hashCode2 = ajyx != null ? ajyx.hashCode() : 0;
        int a = aocd.a(this.b);
        ajzw ajzw = this.c;
