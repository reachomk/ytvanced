...
final class nxr extends oxf {
    ...
    public static nxr a(String str, long j) {
        return new nxr(str, j, -1, -9223372036854775807L, null);
    }
     ...
     */
    public static defpackage.nxr a(java.io.File r16, long r17, long r19, defpackage.nxo r21) {
        /*
        r0 = r21;
        r1 = r16.getName();
        r2 = ".v3.exo";
    ...
    L_0x0040:
        ...
        r1 = defpackage.nxr.a(r7, r8, r9, r11);
        r2 = r16;
        r2 = r2.renameTo(r1);
    ...
    L_0x00b9:
        return r6;
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.nxr.a(java.io.File, long, long, nxo):nxr");
    }

    public nxr(String str, long j, long j2, long j3, File file) {
