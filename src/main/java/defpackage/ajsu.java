...
/* renamed from: ajsu */
public final class ajsu extends aoca {
    private static volatile ajsu[] b;
    public ajsn a;
    ...
    public final boolean equals(Object obj) {
        ...
        } else if (!ajsn.equals(ajsu.a)) {
            return false;
        }
        aocb aocb = this.unknownFieldData;
        if (aocb != null && !aocb.b()) {
            return this.unknownFieldData.equals(ajsu.unknownFieldData);
        }
        aocb aocb2 = ajsu.unknownFieldData;
