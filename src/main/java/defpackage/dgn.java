...
public final class dgn {
    ...
    public static int a(Context context) {
        ...
        try {
            context.getResources().getString(2130968589);
        ...
        try {
            ...
            Log.wtf(str2, "This should never happen.", e);
        ...
        if (bundle != null) {
            ...
            if (i == 4323000) {
                ...
                try {
                    ...
                    try {
                        if (dgn.a(packageManager.getPackageInfo("com.android.vending", 64), a) != null) {
                            if (dgn.a(packageInfo, dgn.a(packageManager.getPackageInfo("com.android.vending", 64), a)) == null) {
                                str3 = "Google Play services signature invalid.";
                            } else if (packageInfo.versionCode < 4323000) {
                                StringBuilder stringBuilder = new StringBuilder();
                                stringBuilder.append("Google Play services out of date.  Requires 4323000 but found ");
                                stringBuilder.append(packageInfo.versionCode);
                                Log.w(str2, stringBuilder.toString());
                                return 2;
                            } else {
                                try {
                                    i = packageManager.getApplicationInfo(str, 0);
                                    return !i.enabled ? 3 : 0;
                                } catch (NameNotFoundException e2) {
                                    Log.wtf(str2, "Google Play services missing when getting application info.");
                                    ankx.a(e2);
                                    return i;
                                }
                            }
                        ...
                        str3 = "Google Play Store is missing.";
                    }
                    Log.w(str2, str3);
                    return 9;
            ...
            stringBuilder2.append("The meta-data tag in your app's AndroidManifest.xml does not have the right value.  Expected 4323000 but found ");
            stringBuilder2.append(i);
            stringBuilder2.append(".  You must have the following declaration within the <application> element:     <meta-data android:name=\"com.google.android.gms.version\" android:value=\"@integer/google_play_services_version\" />");
    ...
    public static Intent a(int i) {
        String str = "com.google.android.gms";
        return (i == 1 || i == 2) ? dgo.b(str) : i != 3 ? i != 12 ? null : dgo.a() : dgo.a(str);
    }
            ...
            if (packageInfo.signatures.length == 1) {
                ...
                try {
                    try {
                        ...
                        str2 = "Certificate has expired.";
                    } catch (CertificateNotYetValidException unused2) {
                        str2 = "Certificate is not yet valid.";
                    }
                } catch (CertificateException unused3) {
                    str2 = "Could not generate certificate.";
                }
            } else {
                str2 = "Package has more than one signature.";
                Log.w(str, str2);
                return null;
            }
        } catch (CertificateException unused4) {
            str2 = "Could not get certificate instance.";
        }
    }
