...
/* renamed from: ajzd */
public final class ajzd extends ajwo {
    public ajyq a;
    public awqo[] b;
    public ajzw c;
    public byte[] d;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof ajzd) {
            ...
            } else if (!ajyq.equals(ajzd.a)) {
                return false;
            }
            if (aocd.a(this.b, ajzd.b)) {
                ajzw ajzw = this.c;
                if (ajzw == null) {
                    if (ajzd.c != null) {
                        return false;
                    }
                } else if (!ajzw.equals(ajzd.c)) {
                    return false;
                }
                if (Arrays.equals(this.d, ajzd.d)) {
                    aojc aojc = this.e;
                    if (aojc == null) {
                        if (ajzd.e != null) {
                            return false;
                        }
                    } else if (!aojc.equals(ajzd.e)) {
                        return false;
                    }
                    ajzw = this.g;
                    if (ajzw == null) {
                    ...
                    } else if (!str.equals(ajzd.f)) {
                        return false;
                    }
                    aocb aocb = this.unknownFieldData;
                    if (aocb != null && !aocb.b()) {
                        return this.unknownFieldData.equals(ajzd.unknownFieldData);
                    }
                    aocb aocb2 = ajzd.unknownFieldData;
