...
/* renamed from: alor */
public final class alor implements akox {
    ...
    public alor(Context context, akkq akkq, OnClickListener onClickListener, OnLongClickListener onLongClickListener, allh allh, acvx acvx) {
    ...
    public final /* synthetic */ akot a(ViewGroup viewGroup) {
        return new aloo(this.a, viewGroup, this.b, this.c, this.d, this.e, this.f, this.g);
    }
}
