...
/* renamed from: ajyw */
public final class ajyw extends ajwo {
    public ajyp a;
    public awqo[] b;
    public ajzw c;
    public byte[] d;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof ajyw) {
            ...
            } else if (!ajyp.equals(ajyw.a)) {
                return false;
            }
            if (aocd.a(this.b, ajyw.b)) {
                ajzw ajzw = this.c;
                if (ajzw == null) {
                    if (ajyw.c != null) {
                        return false;
                    }
                } else if (!ajzw.equals(ajyw.c)) {
                    return false;
                }
                if (Arrays.equals(this.d, ajyw.d) && this.e == ajyw.e) {
                    aojc aojc = this.f;
                    if (aojc == null) {
                        if (ajyw.f != null) {
                            return false;
                        }
                    } else if (!aojc.equals(ajyw.f)) {
                        return false;
                    }
                    ajzw = this.h;
                    if (ajzw == null) {
                    ...
                    } else if (!str.equals(ajyw.g)) {
                        return false;
                    }
                    aocb aocb = this.unknownFieldData;
                    if (aocb != null && !aocb.b()) {
                        return this.unknownFieldData.equals(ajyw.unknownFieldData);
                    }
                    aocb aocb2 = ajyw.unknownFieldData;
