...
/* renamed from: wll */
final class wll implements OnClickListener {
    ...
    wll(wlm wlm, ajsn ajsn, ajsh ajsh, boolean z, acvx acvx, Map map, ImageView imageView, TextView textView, Map map2, ImageView imageView2) {
        this.j = wlm;
        this.a = ajsn;
        this.b = ajsh;
        this.c = z;
