...
/* renamed from: ajyz */
public final class ajyz extends ajwo {
    public ajyx a;
    public awqo[] b;
    public ajzw c;
    public byte[] d;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof ajyz) {
            ...
            } else if (!ajyx.equals(ajyz.a)) {
                return false;
            }
            if (aocd.a(this.b, ajyz.b)) {
                ajzw ajzw = this.c;
                if (ajzw == null) {
                    if (ajyz.c != null) {
                        return false;
                    }
                } else if (!ajzw.equals(ajyz.c)) {
                    return false;
                }
                if (Arrays.equals(this.d, ajyz.d)) {
                    aojc aojc = this.e;
                    if (aojc == null) {
                        if (ajyz.e != null) {
                            return false;
                        }
                    } else if (!aojc.equals(ajyz.e)) {
                        return false;
                    }
                    ajzw = this.g;
                    if (ajzw == null) {
                    ...
                    } else if (!str.equals(ajyz.f)) {
                        return false;
                    }
                    aocb aocb = this.unknownFieldData;
                    if (aocb != null && !aocb.b()) {
                        return this.unknownFieldData.equals(ajyz.unknownFieldData);
                    }
                    aocb aocb2 = ajyz.unknownFieldData;
