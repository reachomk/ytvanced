...
/* renamed from: akbl */
public final class akbl extends aoca {
    public ajsn a;
    ...
    public final boolean equals(Object obj) {
        ...
        } else if (!ajsn.equals(akbl.a)) {
            return false;
        }
        aocb aocb = this.unknownFieldData;
        if (aocb != null && !aocb.b()) {
            return this.unknownFieldData.equals(akbl.unknownFieldData);
        }
        aocb aocb2 = akbl.unknownFieldData;
