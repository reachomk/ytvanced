...
/* renamed from: ajyv */
public final class ajyv extends ajwo {
    public ajyq a;
    public awqo[] b;
    public ajzw c;
    public byte[] d;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof ajyv) {
            ...
            } else if (!ajyq.equals(ajyv.a)) {
                return false;
            }
            if (aocd.a(this.b, ajyv.b)) {
                ajzw ajzw = this.c;
                if (ajzw == null) {
                    if (ajyv.c != null) {
                        return false;
                    }
                } else if (!ajzw.equals(ajyv.c)) {
                    return false;
                }
                if (Arrays.equals(this.d, ajyv.d)) {
                    aojc aojc = this.e;
                    if (aojc == null) {
                        if (ajyv.e != null) {
                            return false;
                        }
                    } else if (!aojc.equals(ajyv.e)) {
                        return false;
                    }
                    ajzw = this.g;
                    if (ajzw == null) {
                    ...
                    } else if (!str.equals(ajyv.f)) {
                        return false;
                    }
                    aocb aocb = this.unknownFieldData;
                    if (aocb != null && !aocb.b()) {
                        return this.unknownFieldData.equals(ajyv.unknownFieldData);
                    }
                    aocb aocb2 = ajyv.unknownFieldData;
