...
/* renamed from: akaz */
public final class akaz extends aoca {
    public akab a;
    ...
    public final boolean equals(Object obj) {
        ...
        } else if (!akab.equals(akaz.a)) {
            return false;
        }
        aocb aocb = this.unknownFieldData;
        if (aocb != null && !aocb.b()) {
            return this.unknownFieldData.equals(akaz.unknownFieldData);
        }
        aocb aocb2 = akaz.unknownFieldData;
