...
/* renamed from: ajul */
public final class ajul extends aoca {
    public akab a;
    ...
    public final boolean equals(Object obj) {
        ...
        } else if (!akab.equals(ajul.a)) {
            return false;
        }
        aocb aocb = this.unknownFieldData;
        if (aocb != null && !aocb.b()) {
            return this.unknownFieldData.equals(ajul.unknownFieldData);
        }
        aocb aocb2 = ajul.unknownFieldData;
