...
/* renamed from: rek */
final /* synthetic */ class rek {
    public static final /* synthetic */ int[] a = new int[rii.values().length];
    ...
    L_0x00da:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.rek.<clinit>():void");
    }
}
