...
final class rib {
    ...
    public static int b(byte[] bArr, int i, int i2) {
        ...
        if (i2 == 1) {
            return rib.a(i3, bArr[i]);
        }
        if (i2 == 2) {
            return rib.a(i3, bArr[i], bArr[i + 1]);
        }
    ...
    L_0x007f:
        goto L_0x007e;
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.rib.a(java.lang.CharSequence):int");
    }
    ...
    static void a(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        if (byteBuffer.hasArray()) {
            ...
            byteBuffer.position(rib.a(charSequence, byteBuffer.array(), byteBuffer.position() + arrayOffset, byteBuffer.remaining()) - arrayOffset);
        } else if (byteBuffer.isDirect()) {
            rie.a(charSequence, byteBuffer);
        } else {
    ...
    static {
        rie rif = (rhv.c && rhv.b) ? new rif() : new rid();
        a = rif;
    }
}
