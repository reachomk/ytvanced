...
/* renamed from: ajze */
public final class ajze extends ajwo {
    public ajyq a;
    public ajyo b;
    public awqm[] c;
    public ajzw d;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof ajze) {
            ...
            } else if (!ajyo.equals(ajze.b)) {
                return false;
            }
            if (aocd.a(this.c, ajze.c)) {
                ajzw ajzw = this.d;
                if (ajzw == null) {
                    if (ajze.d != null) {
                        return false;
                    }
                } else if (!ajzw.equals(ajze.d)) {
                    return false;
                }
                if (Arrays.equals(this.e, ajze.e)) {
                    aojc aojc = this.f;
                    if (aojc == null) {
                        if (ajze.f != null) {
                            return false;
                        }
                    } else if (!aojc.equals(ajze.f)) {
                        return false;
                    }
                    ajzw = this.h;
                    if (ajzw == null) {
                    ...
                    } else if (!str.equals(ajze.g)) {
                        return false;
                    }
                    aocb aocb = this.unknownFieldData;
                    if (aocb != null && !aocb.b()) {
                        return this.unknownFieldData.equals(ajze.unknownFieldData);
                    }
                    aocb aocb2 = ajze.unknownFieldData;
