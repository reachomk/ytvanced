...
/* renamed from: akx */
public class akx extends CheckBox implements abf, adn {
    private final akz a;
    private final akv b;
    private final aly c;
    ...
    public akx(Context context, AttributeSet attributeSet, byte b) {
        super(arv.a(context), attributeSet, R.attr.checkboxStyle);
        this.a = new akz(this);
        this.a.a(attributeSet, R.attr.checkboxStyle);
        this.b = new akv(this);
        this.b.a(attributeSet, R.attr.checkboxStyle);
        this.c = new aly(this);
        this.c.a(attributeSet, (int) R.attr.checkboxStyle);
    }
