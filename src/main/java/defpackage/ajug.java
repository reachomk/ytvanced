...
/* renamed from: ajug */
public final class ajug extends aoca {
    public aqyh a;
    ...
    public final boolean equals(Object obj) {
        ...
        } else if (!aqyh.equals(ajug.a)) {
            return false;
        }
        aocb aocb = this.unknownFieldData;
        if (aocb != null && !aocb.b()) {
            return this.unknownFieldData.equals(ajug.unknownFieldData);
        }
        aocb aocb2 = ajug.unknownFieldData;
