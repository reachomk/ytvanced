...
/* renamed from: qik */
final class qik implements ServiceConnection {
    public int a = 0;
    public final Messenger b = new Messenger(new Handler(Looper.getMainLooper(), new qij(this)));
    public qin c;
    ...
    /* JADX WARNING: Missing block: B:34:0x0080, code skipped:
            return true;
     */
    public final synchronized boolean a(defpackage.qiq r6) {
        /*
        r5 = this;
        monitor-enter(r5);
    ...
    L_0x0081:
        ...
        throw r6;
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.qik.a(qiq):boolean");
    }

    public final synchronized void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        if (iBinder != null) {
            try {
                this.c = new qin(iBinder);
                this.a = 2;
                c();
                return;
    ...
    public final synchronized void a(int i, String str) {
        ...
        if (i2 == 0) {
            ...
            qip qip = new qip(i, str);
            for (qiq a : this.d) {
                a.a(qip);
            }
            this.d.clear();
            for (i = 0; i < this.e.size(); i++) {
                ((qiq) this.e.valueAt(i)).a(qip);
            }
            this.e.clear();
        } else if (i2 == 3) {
            this.a = 4;
    ...
    public final synchronized void a(int i) {
        ...
        if (qiq != null) {
            ...
            this.e.remove(i);
            qiq.a(new qip(3, "Timed out waiting for response"));
            a();
        }
    }

    /* synthetic */ qik(qih qih) {
        this.f = qih;
    }
}
